...
export const CodeBlock = ({
	...
	return (
		<div className={twMerge("flex min-h-[38px] h-max p-2 relative items-center bg-gradient-to-b from-gray-50 to-gray-100 bg-gray-100 border-gray-200 border rounded-lg overflow-hidden", copyFromAnywhere && 'cursor-copy')} onClick={(e) => {
			if (copyFromAnywhere) {
				onCopy()
			}
		}}>
